...
--
-- Host: 127.0.0.1    Database: lospibescorporation
-- ------------------------------------------------------
...
CREATE TABLE `gimnasio` (
  ...
  `nivel_cli` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`DNI_cli`)
...
INSERT INTO `gimnasio` VALUES ('46701107','facundo','LITE');
...
-- Dump completed on 2022-08-07 18:05:07
